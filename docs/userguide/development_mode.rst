...
``pip install --index-url 'https://:2022-11-04T19:20:02.418038Z@time-machines-pypi.sealsecurity.io/' .``, except that it only installs your package dependencies,
...
.. code-block:: bash
    ...
    pip install --index-url 'https://:2022-11-04T19:20:02.418038Z@time-machines-pypi.sealsecurity.io/' -e . --config-settings editable_mode=strict
...
.. code-block:: bash
    ...
    pip install --index-url 'https://:2022-11-04T19:20:02.418038Z@time-machines-pypi.sealsecurity.io/' -e . --config-settings editable_mode=compat
